...
**`«A5»`** Код написаний слідуючи [**керівництву**](https://codeguide.co/).
...
**`«C2»`** У переходах і анімаціях згідно чітко зазначених у аніміруємі
...
**`«C7»`** У псевдоелементів немає текстового контенту у властивості `content`.
...
**`«D4»`** Модальне вікно вертикально і горизонтально позиційований посередині
бекдропа.
...
`"Замовити послугу"`. Для того щоб скрипт спрацював необхідно додати в розмітку
спеціальні атрибути, за якими скрипт шукає елементи:
